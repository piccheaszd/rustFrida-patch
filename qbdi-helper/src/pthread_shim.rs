...
#[no_mangle]
pub unsafe extern "C" fn pthread_join(_thread: pthread_t, retval: *mut *mut c_void) -> c_int {
    if !retval.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn pthread_sigmask(_how: c_int, _set: *const c_void, _oldset: *mut c_void) -> c_int {
    0
}
